...
export default function ProductGrid({ initialProducts }: ProductGridProps) {
  ...
  return (
    <>
      ...
      <section className="bg-white py-6 sm:py-16 lg:py-24">
        <Container>
          {/* Section Header */}
          <div className="mb-6 sm:mb-8 flex flex-col sm:flex-row sm:items-end justify-between gap-3 sm:gap-4 border-b border-neutral-200/80 pb-4 sm:pb-6">
            <div>
              <div className="inline-flex items-center gap-2 px-3.5 py-1 text-[10px] uppercase tracking-[0.3em] font-medium border border-neutral-200 rounded-full bg-neutral-50 text-neutral-700 mb-2 sm:mb-3">
            ...
            <div className="flex items-center justify-between sm:justify-end gap-4">
              <span className="text-[11px] sm:text-xs font-mono text-neutral-400 uppercase tracking-widest">
          ...
          {displayedProducts.length > 0 ? (
            <div
            className={`grid gap-4 sm:gap-5 xl:gap-6 ${
                viewMode === "grid"
            ...
            /* Empty State */
            <div className="my-8 sm:my-12 flex flex-col items-center justify-center rounded-3xl border border-dashed border-neutral-200 bg-neutral-50/50 px-6 py-12 sm:py-16 text-center">
          ...
          {visibleCount < filteredProducts.length && (
            <div className="mt-10 sm:mt-14 flex justify-center">
              <Button
                ...
                className="w-full sm:w-auto border border-neutral-300 bg-neutral-50 text-neutral-900 hover:bg-neutral-950 hover:text-white hover:border-neutral-950"
              >
